...
class App extends React.Component {
  constructor(props) {
    ...
    this.state = { searchResults: [{name: 'name1', artist: 'artist1', album: 'album1', id: 1}],
                  playlistName: 'Jams',
                  playlistTracks: [{name: 'gideon', artist: 'jod and wake', album: 'the nine houses', id: 9}]}
    ...
    <div>
      ...
      <div className="App">
        ...
        <div className="App-playlist">
          ...
          <Playlist playlistName={this.state.playlistName} playlistTracks={this.state.playlistTracks} onRemove={this.removeTrack}></Playlist>
        </div>
      </div>
    </div>
  );
